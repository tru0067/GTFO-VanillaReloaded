...
*The Machine Pistol already has some fairly impressive stats, we opted to give it a slight damage bonus, while also tweaking its falloff, so that it has a similar damage profile at range but can be even more devestating up close.*
...
*We've reverted the PDW's previous damage nerf and given it a bump to its precision to make headshots feel very impactful.*
...
*We've found the Double Tap Rifle to be a generally well-rounded weapon, which already has a fun avenue for skill expression through its one-burst on Strikers. We've slightly buffed its damage to improve its match-up against more diverse enemies.*
...
-   Damage: 15.05 -> 20.1
-   Bullet cost: 1.58 -> 0.87
    -   Rounds/refill: 13.32 -> 12.10
    -   Starting ammo: 44.41 -> 40.33
    -   Maximum ammo: 66 -> 60
-   Shot delay: 0.75 -> 0.8
-   Pellet count: 5 -> 10 (damage per pellet: 3.01 -> 2.01)
-   Pellet spread: 2 -> 1
...
-   Bio-symbiosis bullet cost multiplier: 0.5 -> 0.8
